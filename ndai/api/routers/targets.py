...
async def get_target(
    ...
    return KnownTargetDetailResponse(
        ...
        packages_json=target.packages_json,
        services_json=target.services_json,
        build_steps_json=target.build_steps_json,
        config_files_json=target.config_files_json,
